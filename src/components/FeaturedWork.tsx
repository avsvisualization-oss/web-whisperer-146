  ...
  return (
    <section className="section-padding bg-secondary/50">
      <div className="container-wide">
        ...
        >
          <div>
            <div className="label-mono text-muted-foreground mb-5">Featured Work</div>
          ...
          <Link
            to="/portfolio"
            className="hidden md:inline-flex items-center gap-2 text-[13px] font-medium text-foreground hover:text-muted-foreground transition-colors tracking-wide"
          >
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400">
                <div className="label-mono text-white/60 mb-1.5">
                  {project.category}
                </div>
                <h3 className="font-display text-lg font-semibold text-white tracking-[-0.02em]">
                  {project.title}
                </h3>
              </div>
            </motion.div>
        ...
        <div className="mt-10 text-center md:hidden">
          <Link
            to="/portfolio"
            className="inline-flex items-center gap-2 text-[13px] font-medium text-foreground tracking-wide"
          >
            View All <ArrowUpRight className="w-3.5 h-3.5" />
          </Link>
        </div>
