...
const HeroSection = () => {
  return (
    <section className="relative h-[90vh] md:h-screen flex items-center overflow-hidden pt-20">
      {/* Background Video */}
      <div className="absolute inset-0">
        <iframe
          src="https://player.vimeo.com/video/1168503087?background=1&autoplay=1&loop=1&muted=1&quality=720p"
          className="absolute inset-0 w-full h-full"
          style={{ border: 0, objectFit: 'cover', transform: 'scale(1.2)' }}
      ...
      {/* Content */}
      <div className="relative container-wide py-10 md:py-0">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
